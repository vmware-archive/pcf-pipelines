...
jq -n \
  ...
  '
  {
    ...
    "jobs": {
      ...
      "router": {"instance_type": {"id": "automatic"},"instances": 3,"elb_names": [],"internet_connected": false},
      ...
      "diego_brain": {"instance_type": {"id": "automatic"},"instances": 3,"elb_names": [],"internet_connected": false,"persistent_disk":{"size_mb":"automatic"}},
