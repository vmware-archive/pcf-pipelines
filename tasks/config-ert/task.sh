...
cf_resources=$(
  jq -n \
    ...
    '
    {
      ...
      "mysql_monitor": { "instances": $mysql_monitor_instance, "internet_connected": $internet_connected },
      ...
      "doppler": { "instances": $doppler_instance, "internet_connected": $internet_connecteds },
