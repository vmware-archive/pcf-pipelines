...
# -
source pcf-pipelines/install-pcf/gcp/functions/misc.sh
# opsman_host
source pcf-pipelines/install-pcf/gcp/functions/config-director-json-fn-opsman-curl.sh
# json_file_path
source pcf-pipelines/install-pcf/gcp/functions/config-director-json-fn-opsman-auth.sh
# json_file_path
source pcf-pipelines/install-pcf/gcp/functions/config-director-json-fn-opsman-json-to-post-data.sh
# opsman_host, pcf_opsman_admin_passwd
source pcf-pipelines/install-pcf/gcp/functions/config-director-json-fn-opsman-extensions.sh
# -
source pcf-pipelines/install-pcf/gcp/functions/config-director-json-fn-opsman-config-director.sh
