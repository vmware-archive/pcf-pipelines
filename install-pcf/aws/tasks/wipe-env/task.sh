...
terraform destroy \
  ...
  -var "public_subnet_cidr_az1=0.0.0.0/16" \
  -var "public_subnet_cidr_az2=0.0.0.0/16" \
  -var "public_subnet_cidr_az3=0.0.0.0/16" \
  -var "ert_subnet_cidr_az1=0.0.0.0/16" \
  -var "ert_subnet_cidr_az2=0.0.0.0/16" \
  -var "ert_subnet_cidr_az3=0.0.0.0/16" \
  -var "services_subnet_cidr_az1=0.0.0.0/16" \
  -var "services_subnet_cidr_az2=0.0.0.0/16" \
  -var "services_subnet_cidr_az3=0.0.0.0/16" \
  -var "dynamic_services_subnet_cidr_az1=0.0.0.0/16" \
  -var "dynamic_services_subnet_cidr_az2=0.0.0.0/16" \
  -var "dynamic_services_subnet_cidr_az3=0.0.0.0/16" \
  -var "infra_subnet_cidr_az1=0.0.0.0/16" \
  -var "rds_subnet_cidr_az1=0.0.0.0/16" \
  -var "rds_subnet_cidr_az2=0.0.0.0/16" \
  -var "rds_subnet_cidr_az3=0.0.0.0/16" \
