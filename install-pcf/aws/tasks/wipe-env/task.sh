...
terraform destroy \
  ...
  -var "prefix=dontcare" \
  -var "opsman_allow_ssh=dontcare" \
  -var "opsman_allow_ssh_cidr_ranges=dontcare" \
  -var "opsman_allow_https=dontcare" \
  -var "opsman_allow_https_cidr_ranges=dontcare" \
  ...
  -var "vpc_cidr=dontcare" \
  -var "public_subnet_cidr_az1=dontcare" \
  -var "public_subnet_cidr_az2=dontcare" \
  -var "public_subnet_cidr_az3=dontcare" \
  -var "ert_subnet_cidr_az1=dontcare" \
  -var "ert_subnet_cidr_az2=dontcare" \
  -var "ert_subnet_cidr_az3=dontcare" \
  -var "services_subnet_cidr_az1=dontcare" \
  -var "services_subnet_cidr_az2=dontcare" \
  -var "services_subnet_cidr_az3=dontcare" \
  -var "dynamic_services_subnet_cidr_az1=dontcare" \
  -var "dynamic_services_subnet_cidr_az2=dontcare" \
  -var "dynamic_services_subnet_cidr_az3=dontcare" \
  -var "infra_subnet_cidr_az1=dontcare" \
  -var "rds_subnet_cidr_az1=dontcare" \
  -var "rds_subnet_cidr_az2=dontcare" \
  -var "rds_subnet_cidr_az3=dontcare" \
